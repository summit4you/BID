...
- (void)viewDidLoad {
    ...
    CGFloat inset = 20; // left space width
    
    CGFloat temperatureHeight = 110;
    CGFloat hiloHeight = 40;
    CGFloat iconHeight = 30;
    
    CGRect hiloFrame = CGRectMake(inset, headerFrame.size.height-hiloHeight, headerFrame.size.width-(2*inset),
                                  hiloHeight);
    
    CGRect temperatureFrame = CGRectMake(inset, headerFrame.size.height - (temperatureHeight + hiloHeight),
    ...
    [[RACObserve([WXManager sharedManager], currentCondition)
     ...
     subscribeNext:^(WXCondition *newCondition) {
         ...
         conditionsLabel.text = [((WXWeather *)[[newCondition weather] objectAtIndex:0]).condition capitalizedString];
...
- (void)configureHourlyCell:(UITableViewCell *)cell weather:(WXCondition *)weather {
    ...
    cell.detailTextLabel.font = [UIFont fontWithName:@"HelevtcaNeue-Medium" size:18];
